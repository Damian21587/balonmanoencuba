    ...
    <div class="absolute inset-0 z-10 text-white text-center flex flex-col items-center justify-center">
        <div class="container mx-auto">
            <div class="text-center mb-20 pt-10 sm:pt-10">
                ...
                <h2 class="lg:text-2xl text-sm leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-white uppercase dosis-extralight dosis-regular">Xesco Espark</h2>
            </div>
        </div>
    </div>
...
{{--<div class="relative overflow-hidden bg-cover bg-center h-auto text-white py-32 px-10 object-fill" style="background-image: url('../image/bg.jpg')">
    <div class="container mx-auto">
        <div class="text-center mb-20">
            <h1 class="sm:text-7xl text-2xl uppercase lato-hairline mb-4">Be a pro sportman</h1>
            <p class="text-2xl leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-white uppercase dosis-extralight dosis-regular">simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley</p>
...
<div class="relative -mt-12 lg:-mt-24">
    <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(-4.000000, 76.000000)" fill="rgba(249, 250, 251)" fill-rule="nonzero">
                <path
